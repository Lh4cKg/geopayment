            ...
            for field, type_hint in annotations.items():
                ...
                if isinstance(type_hint, (types.GenericAlias, t._GenericAlias)):
                    ...
                    for union_arg in t.get_args(type_hint):
                        if isinstance(union_arg, (types.GenericAlias, t._GenericAlias)):
                            self.__generic_alias_validation(
                    ...
                    self.__decimal_validation(field, value, type_hint)
                elif type_hint is int:
                    self.__int_validation(field, value, type_hint)
                elif type_hint is float:
                    self.__float_validation(field, value, type_hint)
